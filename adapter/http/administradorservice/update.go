...
// Update goDoc
// @Summary Update administrador
// @Description Update administrador by id
// @Tags administrador
// @Accept  json
// @Produce  json
...
func (service service) Update(c *gin.Context) {
	...
	administrador, err := service.usecase.Update(int32(id), administradorRequest)
